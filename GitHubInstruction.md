...
###  Fork и Pull Request
GitHab  позволяет вносить вклад в уже существующие проекты, путем создания свое собственного ответвления этого проекта (Fork).
Тоесть вы можете создать собственную копию публичного проекта и дорабатывать его, в последствии предлагая эти изменения принять (Pull Request)

 ###  Основные команды для работы с удаленными репозиториями

 Для переноса удаленного репозитория на ваш локальный используют команду 
 ```
 git clone <url>
 ```
